...
var v = new Vue({
   el:'#app',
    ...
    methods:{
        ...
        imgUser(value){
            if(!value) return v.url+'assets/img/user_images/no_image.png'
            return value //for image gender sign in the table
        },
        imgGender(value){
            return v.url+'assets/img/user_images/gender_'+value+'.png' //for image gender sign in the table
        },
