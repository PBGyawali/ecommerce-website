Vue.component('pagination',{
   ...
   <ul class="pagination justify-content-center">
    <li @click="updatePage(prev)" class="page-item">
      <a v-if="showPrevLink"class="page-link fa fa-arrow-left" href="javascript:void(0)" aria-label="Previous"> Previous
      </a>
    </li>
...
<a class="page-link" @click="updatePage(totalPages - 1)" href="javascript:void(0)">{{totalPages}}</a>
    ...
    <li @click="updatePage(next)" class="page-item">
      <a v-if="showNextLink"class="page-link " href="javascript:void(0)" aria-label="Next">Next <i class=" fa fa-arrow-right"></i> 
      </a>
    </li>
  </ul>
      </div>`,
    props:['current_page', 'row_count_page','total_results','page_range'], 
    computed:{
        prev(){
        ...
        pages(){
         ...
         totalPages(){
        return Math.ceil(this.total_results / this.row_count_page);  
        },
        firstPage(){
