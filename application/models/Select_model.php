<?php
	...
	{
		$html = '<select name="store_currency" id="store_currency" class="form-control" required>
	...
	function Timezone_list($value=null)
	{
		...
		$html = '
		<select name="website_timezone" id="website_timezone" class="form-control" required>
	...
	$country=array(
		...
		$html = '<select name="store_country" id="store_country" class="form-control" required>
