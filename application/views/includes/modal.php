<!--     registration-->
      <modal v-if="registerForm" @close="closeRegisterForm()">
        <div slot="head" class="text-center"><h2>Create your account</h2></div>
        <div class="mt-3" slot="body">
         ...
         <div class="col-md-6">
               <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="Firstname":class="{'is-invalid': rValidate.firstname}" name="firstname" v-model="userRegister.firstname">
              </div>
                <p v-if="rValidate.firstname" class="text-danger" v-html="rValidate.firstname"></p>                
                
                <div class="input-group mt-4">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fa fa-user"></i></span>
                </div>
                <input type="text" class="form-control":class="{'is-invalid': rValidate.lastname}" placeholder="Lastname" name="lastname" v-model="userRegister.lastname">
              </div>              
               <p v-if="rValidate.lastname" class="text-danger" v-html="rValidate.lastname"></p>
               
              <div class="input-group  mt-4">
                <div class="input-group-prepend">
                  <span class="input-group-text"> <i class="fa fa-user"></i></span>
                </div>
                <input type="text" class="form-control" :class="{'is-invalid': rValidate.username}" placeholder="Username" name="username" v-model="userRegister.username">
              </div>
             <p v-if="rValidate.username" class="text-danger" v-html="rValidate.username"></p>
          </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" :class="{'is-invalid': rValidate.email}" placeholder="Email" name="email" v-model="userRegister.email">
              </div>
              
             <p v-if="rValidate.email" class="text-danger" v-html="rValidate.email"></p>
              ...
              <div class="input-group  mt-4">
                ...
                <input type="password" class="form-control":class="{'is-invalid': rValidate.password}"  placeholder="Password" name="password" v-model="userRegister.password">
              </div>              
                <p v-if="rValidate.password" class="text-danger" v-html="rValidate.password"></p>             
              <div class="input-group mt-4">
                <div class="input-group-prepend">
                  <span class="input-group-text">
                    <i class="fa fa-lock"></i>
                ...
                <input type="password" class="form-control" :class="{'is-invalid': rValidate.confirm_password}" placeholder="Repeat password" name="confirm_password" v-model="userRegister.confirm_password">
              </div>
               <p v-if="rValidate.confirm_password" class="text-danger" v-html="rValidate.confirm_password"></p>
            </div>
          </div>
            </div>            
        </div>
          <button type="submit" slot="foot"class="btn btn-primary btn-block mx-3" @click="register()"><i class='fa fa-refresh fa-spin mx-2'  v-if='registerstate'></i> Create Account</button>
      ...
      <!--   forgot password-->
       <modal v-if="store.state.forgotPassword" @close="store.commit('closeForgotPw')">
        <div slot="head"> <h2>Forgot Password</h2></div>
        <div class="container" slot="body">
            <p class="text-muted text-center">We can help you reset your password using your email address</p>            
                <div class="input-group ">
                  ...
                  <input type="text" v-model="store.state.sendMail.email" class="form-control" :class="{'is-invalid': store.state.emailValidate}"placeholder="Email">
                </div>
...
<!--enter code-->
      <modal v-if="store.state.showEnterCode" @close="store.commit('closeEnterCode')">    
        <div slot="head"><h2>Enter Security Code</h2></div>
        <div class="container" slot="body">
